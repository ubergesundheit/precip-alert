class TimeReader
#first digit position (11,11,8,10)
#second digit position (20,11,8,10)
#third digit position (35,11,8,10)
...
@digits_data =["data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAgAAAAKBAMAAAB76QKzAAAAKlBMVEUMCgwUFhQcHiQsKiw0MjRERkRUVlRkZmR8enyEhoS8urzc2tzs6uz8+vzNe8hcAAAAPUlEQVR4nAEyAM3/Ajm9yTMCQqeSQAIsz8wwAh3gDSACDxDfEAL+7v7+AvIAA/AC4wAC4ALFQEXAAq1sXa/YvhOyMRR+IwAAAABJRU5ErkJggg==",
  ...
  def read_time
    image = ChunkyPNG::Image.from_file("tmp/regen_4.png")
    first = image.crop(11,11,8,10)
    #second = image.crop(20,11,8,10)
    #third = image.crop(35,11,8,10)

    digits = []
    @digits_data.each do |data|
      digits << ChunkyPNG::Image.from_data_url(data)
    end
